...
function createPanel(data) {
  ...
  cardContainer.classList.add("article");
  ...
  cardContainer.append(title, date, p1, p2, p3, expandButton);

  expandButton.addEventListener("click", () => {
    cardContainer.classList.toggle("article-open");
    if (expandButton.textContent === "View Article") {
